...
public enum SqlConstraints {
    ...
    COUNTRY_NOT_UNIQUE("country.country_UNIQUE", "CountryInvalid", "Country already exists"),
    SECTOR_NOT_UNIQUE("sector.sector_UNIQUE", "SectorInvalid", "Sector already exists");
